				...
				<header class="header" role="banner">
						...
						<div class="small-12 columns">
								<div id="usertext">
										...
										if (!is_user_logged_in()) {
											...
											<div id="open">Hej <?php //echo $greeting[$rand]; ?> <b><?php echo $user_firstname; ?></b>. <br>Du  har <b><?php echo $user_klip; ?></b> klip <img src="<?php bloginfo('template_directory'); ?>/images/arrow-down.jpg"></div>

											<div id="myinfo">
												<ul id="myinfo_ul">
													<li>
														<a href="<?php echo $url; ?>/upload">Del tøj</a>
													</li>
													<li>
														<a href="<?php echo $url; ?>/profile?userid=<?php echo $userID; ?>">profil</a>
													</li>
													<li>
					...
					<form  action="<?php echo $url ?>/sort/" id="sortselect" method="GET">
							...
							<div class="large-1 columns">
								<label for="right-label" class="right inline">Størrelse</label>
							</div>
							<div class="large-2 columns">
								<select tabindex="3" name="size" class="select" placeholder"Størrelse">
							...
							<div class="large-2 columns">
								<select name="kat" class="select" tabindex="2">
							...
							<div class="large-2 columns">
								<select name="brand" class="select" tabindex="1">
									<?php
									if ($brand == "Alle"){
									?>
							...
							<div class="large-3 columns" id="submit-sortmenu">
