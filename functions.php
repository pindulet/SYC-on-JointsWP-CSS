...
add_image_size( 'joints-thumb-300', 300, 300, true );
/*
...
function my_add_frontend_scripts() {
	...
	//Enqueue og Register Jquery ui inkl stylesheet
	wp_enqueue_script('jquery-ui-autocomplete', '', array('jquery-ui-widget', 'jquery-ui-position'), '1.8.6');
	wp_enqueue_style('jquery-ui-autocomplete');
	//wp_enqueue_style( 'jqueryui-stylesheet', get_template_directory_uri() . '/js/jquery_ui/css/ui-lightness/jquery-ui-1.9.2.custom.css', false, 1.0, 'screen' );
}
